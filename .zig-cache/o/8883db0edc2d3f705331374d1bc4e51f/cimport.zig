...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/x86-linux-gnu/bits/floatn.h:79:24: warning: unsupported type: 'Complex'
pub const __cfloat128 = @compileError("unable to resolve typedef child type");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/x86-linux-gnu/bits/floatn.h:79:24
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:74:7: warning: struct demoted to opaque type - has bitfield
...
pub extern fn modp_itoa10(value: i32, buf: [*c]u8) [*c]u8;
pub extern fn modp_uitoa10(value: u32, buf: [*c]u8) [*c]u8;
pub extern fn modp_litoa10(value: i64, buf: [*c]u8) [*c]u8;
pub extern fn modp_ulitoa10(value: u64, buf: [*c]u8) [*c]u8;
pub extern fn modp_dtoa(value: f64, buf: [*c]u8, precision: c_int) [*c]u8;
pub extern fn modp_dtoa2(value: f64, buf: [*c]u8, precision: c_int) [*c]u8;
pub const ptrdiff_t = c_long;
pub const max_align_t = extern struct {
    __clang_max_align_nonce1: c_longlong align(8) = @import("std").mem.zeroes(c_longlong),
    __clang_max_align_nonce2: c_longdouble align(16) = @import("std").mem.zeroes(c_longdouble),
};
pub const EV3_KEY__NONE_: c_int = 0;
pub const EV3_KEY_UP: c_int = 1;
pub const EV3_KEY_DOWN: c_int = 2;
pub const EV3_KEY_LEFT: c_int = 4;
pub const EV3_KEY_RIGHT: c_int = 8;
pub const EV3_KEY_CENTER: c_int = 16;
pub const EV3_KEY_BACK: c_int = 32;
const enum_unnamed_5 = c_uint;
pub export var ev3_brick_addr: [*c]u8 = null;
pub export var ev3_brick_port: u16 = @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 8800)))));
pub const byte = u8;
pub const dword = u32;
pub const INX_T = u8;
pub const FLAGS_T = u8;
pub export fn ev3_init() c_int {
    var i: c_int = undefined;
    _ = &i;
    if (udp_ev3_open(ev3_brick_addr, ev3_brick_port) == -@as(c_int, 1)) return -@as(c_int, 1);
    if (ev3_brick_addr == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        {
            i = 0;
            while (i < @as(c_int, 10)) : (i += 1) {
                if (udp_ev3_catch_address() != 0) return @as(c_int, 1);
                _ = usleep(@as(__useconds_t, @bitCast(@as(c_int, 1000) * @as(c_int, 1000))));
            }
        }
    }
    return @as(c_int, 0);
}
pub export fn ev3_uninit() void {
    _ = udp_ev3_close();
}
pub export fn ev3_write_binary(arg_fn: [*c]const u8, arg_data: [*c]u8, arg_sz: usize) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var data = arg_data;
    _ = &data;
    var sz = arg_sz;
    _ = &sz;
    return @as(usize, @bitCast(@as(c_long, udp_ev3_write(@as([*c]u8, @ptrCast(@volatileCast(@constCast(@"fn")))), @as(?*anyopaque, @ptrCast(data)), @as(c_int, @bitCast(@as(c_uint, @truncate(sz))))))));
}
pub export fn ev3_write(arg_fn: [*c]const u8, arg_value: [*c]u8) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var value = arg_value;
    _ = &value;
...
pub export fn ev3_write_bool(arg_fn: [*c]const u8, arg_value: bool) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var value = arg_value;
    _ = &value;
    return ev3_write_binary(@"fn", if (@as(c_int, @intFromBool(value)) != 0) "1" else "0", @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))));
}
pub export fn ev3_write_int(arg_fn: [*c]const u8, arg_value: c_int) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var value = arg_value;
    _ = &value;
    ...
    _ = &s;
    _ = modp_itoa10(value, @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))));
    return ev3_write(@"fn", @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))));
}
pub export fn ev3_write_dword(arg_fn: [*c]const u8, arg_value: u32) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var value = arg_value;
    _ = &value;
    ...
    _ = &s;
    _ = modp_uitoa10(value, @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))));
    return ev3_write(@"fn", @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))));
}
pub export fn ev3_write_byte(arg_fn: [*c]const u8, arg_value: u8) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var value = arg_value;
    _ = &value;
    return ev3_write_int(@"fn", @as(c_int, @bitCast(@as(c_uint, value))));
}
pub export fn ev3_write_float(arg_fn: [*c]const u8, arg_value: f32) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var value = arg_value;
    _ = &value;
    ...
    _ = &s;
    _ = modp_dtoa2(@as(f64, @floatCast(value)), @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))), @as(c_int, 4));
    return ev3_write(@"fn", @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))));
}
pub export fn ev3_write_char_array(arg_fn: [*c]const u8, arg_value: [*c]u8) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var value = arg_value;
    _ = &value;
...
pub export fn ev3_write_byte_array(arg_fn: [*c]const u8, arg_value: [*c]u8, arg_sz: usize) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var value = arg_value;
    _ = &value;
    var sz = arg_sz;
    _ = &sz;
    return ev3_write_binary(@"fn", @as([*c]u8, @ptrCast(@alignCast(value))), sz);
}
pub export fn ev3_multi_write_binary(arg_sn: [*c]u8, arg_pos: u16, arg_fn: [*c]const u8, arg_data: [*c]u8, arg_sz: usize) usize {
    var sn = arg_sn;
    _ = &sn;
    var pos = arg_pos;
    _ = &pos;
    ...
    var sz = arg_sz;
    _ = &sz;
    return @as(usize, @bitCast(@as(c_long, udp_ev3_multi_write(sn, pos, @as([*c]u8, @ptrCast(@volatileCast(@constCast(@"fn")))), @as(?*anyopaque, @ptrCast(data)), @as(c_int, @bitCast(@as(c_uint, @truncate(sz))))))));
}
pub export fn ev3_multi_write(arg_sn: [*c]u8, arg_pos: u16, arg_fn: [*c]const u8, arg_value: [*c]u8) usize {
    var sn = arg_sn;
    _ = &sn;
    var pos = arg_pos;
    _ = &pos;
...
pub export fn ev3_multi_write_bool(arg_sn: [*c]u8, arg_pos: u16, arg_fn: [*c]const u8, arg_value: bool) usize {
    var sn = arg_sn;
    _ = &sn;
    var pos = arg_pos;
    _ = &pos;
    ...
    var value = arg_value;
    _ = &value;
    return ev3_multi_write_binary(sn, pos, @"fn", if (@as(c_int, @intFromBool(value)) != 0) "1" else "0", @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))));
}
pub export fn ev3_multi_write_int(arg_sn: [*c]u8, arg_pos: u16, arg_fn: [*c]const u8, arg_value: c_int) usize {
    var sn = arg_sn;
    _ = &sn;
    var pos = arg_pos;
    _ = &pos;
    ...
    _ = &s;
    _ = modp_itoa10(value, @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))));
    return ev3_multi_write(sn, pos, @"fn", @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))));
}
pub export fn ev3_multi_write_dword(arg_sn: [*c]u8, arg_pos: u16, arg_fn: [*c]const u8, arg_value: u32) usize {
    var sn = arg_sn;
    _ = &sn;
    var pos = arg_pos;
    _ = &pos;
...
pub export fn ev3_multi_write_byte(arg_sn: [*c]u8, arg_pos: u16, arg_fn: [*c]const u8, arg_value: u8) usize {
    var sn = arg_sn;
    _ = &sn;
    var pos = arg_pos;
    _ = &pos;
    ...
    var value = arg_value;
    _ = &value;
    return ev3_multi_write_int(sn, pos, @"fn", @as(c_int, @bitCast(@as(c_uint, value))));
}
pub export fn ev3_multi_write_float(arg_sn: [*c]u8, arg_pos: u16, arg_fn: [*c]const u8, arg_value: f32) usize {
    var sn = arg_sn;
    _ = &sn;
    var pos = arg_pos;
    _ = &pos;
...
pub export fn ev3_multi_write_char_array(arg_sn: [*c]u8, arg_pos: u16, arg_fn: [*c]const u8, arg_value: [*c]u8) usize {
    var sn = arg_sn;
    _ = &sn;
    var pos = arg_pos;
    _ = &pos;
...
pub export fn ev3_multi_write_byte_array(arg_sn: [*c]u8, arg_pos: u16, arg_fn: [*c]const u8, arg_value: [*c]u8, arg_sz: usize) usize {
    var sn = arg_sn;
    _ = &sn;
    var pos = arg_pos;
    _ = &pos;
    ...
    var sz = arg_sz;
    _ = &sz;
    return ev3_multi_write_binary(sn, pos, @"fn", @as([*c]u8, @ptrCast(@alignCast(value))), sz);
}
pub export fn ev3_read_binary(arg_fn: [*c]const u8, arg_buf: [*c]u8, arg_sz: usize) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    var sz = arg_sz;
    _ = &sz;
    return @as(usize, @bitCast(@as(c_long, udp_ev3_read(@as([*c]u8, @ptrCast(@volatileCast(@constCast(@"fn")))), @as(?*anyopaque, @ptrCast(buf)), @as(c_int, @bitCast(@as(c_uint, @truncate(sz))))))));
}
pub export fn ev3_read(arg_fn: [*c]const u8, arg_buf: [*c]u8, arg_sz: usize) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    ...
    _ = &c;
    if (sz < @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
    c = ev3_read_binary(@"fn", buf, sz);
    buf[c -% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))] = '\x00';
    return c;
}
pub export fn ev3_read_bool(arg_fn: [*c]const u8, arg_buf: [*c]bool) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    var _int: c_int = undefined;
    _ = &_int;
    if (ev3_read_int(@"fn", &_int) != 0) {
        buf.* = !!(_int != 0);
        return @sizeOf(bool);
    }
    return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
}
pub export fn ev3_read_int(arg_fn: [*c]const u8, arg_buf: [*c]c_int) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    ...
    _ = &end;
    if (ev3_read(@"fn", @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))), @sizeOf([21]u8)) != 0) {
        buf.* = @as(c_int, @bitCast(@as(c_int, @truncate(strtol(@as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))), &end, @as(c_int, 0))))));
        if (end.* != 0) return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
        return @sizeOf(c_int);
    }
    return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
}
pub export fn ev3_read_dword(arg_fn: [*c]const u8, arg_buf: [*c]u32) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    ...
    var end: [*c]u8 = undefined;
    _ = &end;
    if (ev3_read(@"fn", @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))), @sizeOf([20]u8)) != 0) {
        buf.* = @as(u32, @bitCast(@as(c_uint, @truncate(strtoul(@as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))), &end, @as(c_int, 0))))));
        if (end.* != 0) return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
        return @sizeOf(u32);
    }
    return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
}
pub export fn ev3_read_byte(arg_fn: [*c]const u8, arg_buf: [*c]u8) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    ...
    _ = &_int;
    if (ev3_read_int(@"fn", &_int) != 0) {
        buf.* = @as(u8, @bitCast(@as(i8, @truncate(_int))));
        return @sizeOf(u8);
    }
    return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
}
pub export fn ev3_read_float(arg_fn: [*c]const u8, arg_buf: [*c]f32) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    ...
    var end: [*c]u8 = undefined;
    _ = &end;
    if (ev3_read(@"fn", @as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))), @sizeOf([16]u8)) != 0) {
        buf.* = @as(f32, @floatCast(strtod(@as([*c]u8, @ptrCast(@alignCast(&s[@as(usize, @intCast(0))]))), &end)));
        if (end.* != 0) return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
        return @sizeOf(f32);
    }
    return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
}
pub export fn ev3_read_char_array(arg_fn: [*c]const u8, arg_buf: [*c]u8, arg_sz: usize) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
...
pub export fn ev3_read_byte_array(arg_fn: [*c]const u8, arg_buf: [*c]u8, arg_sz: usize) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    var sz = arg_sz;
    _ = &sz;
    return ev3_read_binary(@"fn", @as([*c]u8, @ptrCast(@alignCast(buf))), sz);
}
pub export fn ev3_listdir(arg_fn: [*c]const u8, arg_buf: [*c]u8, arg_sz: usize) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    ...
    _ = &c;
    if (sz < @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) return @as(usize, @bitCast(@as(c_long, @as(c_int, 0))));
    c = __ev3_listdir(@as([*c]u8, @ptrCast(@volatileCast(@constCast(@"fn")))), buf, sz);
    buf[c -% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))] = '\x00';
    return c;
}
pub export fn ev3_read_keys(arg_buf: [*c]u8) usize {
    var buf = arg_buf;
    _ = &buf;
    return @as(usize, @bitCast(@as(c_long, udp_ev3_read_keys(buf))));
}
pub export fn ev3_poweroff() bool {
    return udp_ev3_poweroff() != 0;
}
pub export fn ev3_string_suffix(arg_prefix: [*c]const u8, arg_s: [*c][*c]u8, arg_buf: [*c]u32) c_int {
    ...
    var end: [*c]u8 = undefined;
    _ = &end;
    var l: u32 = @as(u32, @bitCast(@as(c_uint, @truncate(strlen(prefix)))));
    _ = &l;
    if (memcmp(@as(?*const anyopaque, @ptrCast(s.*)), @as(?*const anyopaque, @ptrCast(prefix)), @as(c_ulong, @bitCast(@as(c_ulong, l)))) != 0) return @as(c_int, 0);
    buf.* = @as(u32, @bitCast(@as(c_uint, @truncate(strtoul(s.* + l, &end, @as(c_int, 0))))));
    s.* = end;
    if (s.*.* != 0) return @as(c_int, 2);
    return @as(c_int, 1);
}
pub extern fn udp_ev3_open(addr: [*c]u8, port: u16) c_int;
pub extern fn udp_ev3_close() c_int;
pub extern fn udp_ev3_catch_address() c_int;
pub extern fn udp_ev3_read(@"fn": [*c]u8, buf: ?*anyopaque, sz: c_int) c_int;
pub extern fn udp_ev3_write(@"fn": [*c]u8, data: ?*anyopaque, sz: c_int) c_int;
pub extern fn udp_ev3_multi_write(sn: [*c]u8, pos: u16, @"fn": [*c]u8, data: ?*anyopaque, sz: c_int) c_int;
pub extern fn udp_ev3_listdir(@"fn": [*c]u8, buf: ?*anyopaque, sz: c_int) c_int;
pub extern fn udp_ev3_read_keys(buf: [*c]u8) c_int;
pub extern fn udp_ev3_poweroff() c_int;
...
pub fn __ev3_listdir(arg_fn: [*c]u8, arg_buf: [*c]u8, arg_sz: usize) callconv(.c) usize {
    var @"fn" = arg_fn;
    _ = &@"fn";
    var buf = arg_buf;
    _ = &buf;
    var sz = arg_sz;
    _ = &sz;
    return @as(usize, @bitCast(@as(c_long, udp_ev3_listdir(@"fn", @as(?*anyopaque, @ptrCast(buf)), @as(c_int, @bitCast(@as(c_uint, @truncate(sz))))))));
}
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/features.h:199:9
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:45:10
pub inline fn __glibc_has_builtin(name: anytype) @TypeOf(__has_builtin(name)) {
    _ = &name;
    return __has_builtin(name);
}
pub const __glibc_has_extension = @compileError("unable to translate macro: undefined identifier `__has_extension`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:55:10
pub const __LEAF = "";
pub const __LEAF_ATTR = "";
pub const __THROW = @compileError("unable to translate macro: undefined identifier `__nothrow__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:79:11
pub const __THROWNL = @compileError("unable to translate macro: undefined identifier `__nothrow__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:80:11
pub const __NTH = @compileError("unable to translate macro: undefined identifier `__nothrow__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:81:11
pub const __NTHNL = @compileError("unable to translate macro: undefined identifier `__nothrow__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:82:11
pub const __COLD = @compileError("unable to translate macro: undefined identifier `__cold__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:102:11
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:131:9
pub const __STRING = @compileError("unable to translate C expr: unexpected token '#'");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:132:9
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:151:10
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:370:10
pub const __errordecl = @compileError("unable to translate C expr: unexpected token 'extern'");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:371:10
pub const __flexarr = @compileError("unable to translate C expr: unexpected token '['");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:379:10
pub const __glibc_c99_flexarr_available = @as(c_int, 1);
pub const __REDIRECT = @compileError("unable to translate C expr: unexpected token '__asm__'");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:410:10
pub const __REDIRECT_NTH = @compileError("unable to translate C expr: unexpected token '__asm__'");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:417:11
pub const __REDIRECT_NTHNL = @compileError("unable to translate C expr: unexpected token '__asm__'");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:419:11
pub const __ASMNAME = @compileError("unable to translate C expr: unexpected token ','");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:422:10
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:452:10
pub const __attribute_alloc_size__ = @compileError("unable to translate C expr: unexpected token ''");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:463:10
pub const __attribute_alloc_align__ = @compileError("unable to translate macro: undefined identifier `__alloc_align__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:469:10
pub const __attribute_pure__ = @compileError("unable to translate macro: undefined identifier `__pure__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:479:10
pub const __attribute_const__ = @compileError("unable to translate C expr: unexpected token '__attribute__'");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:486:10
pub const __attribute_maybe_unused__ = @compileError("unable to translate macro: undefined identifier `__unused__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:492:10
pub const __attribute_used__ = @compileError("unable to translate macro: undefined identifier `__used__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:501:10
pub const __attribute_noinline__ = @compileError("unable to translate macro: undefined identifier `__noinline__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:502:10
pub const __attribute_deprecated__ = @compileError("unable to translate macro: undefined identifier `__deprecated__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:510:10
pub const __attribute_deprecated_msg__ = @compileError("unable to translate macro: undefined identifier `__deprecated__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:520:10
pub const __attribute_format_arg__ = @compileError("unable to translate macro: undefined identifier `__format_arg__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:533:10
pub const __attribute_format_strfmon__ = @compileError("unable to translate macro: undefined identifier `__format__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:543:10
pub const __attribute_nonnull__ = @compileError("unable to translate macro: undefined identifier `__nonnull__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:555:11
pub inline fn __nonnull(params: anytype) @TypeOf(__attribute_nonnull__(params)) {
    _ = &params;
    return __attribute_nonnull__(params);
}
pub const __returns_nonnull = @compileError("unable to translate macro: undefined identifier `__returns_nonnull__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:568:10
pub const __attribute_warn_unused_result__ = @compileError("unable to translate macro: undefined identifier `__warn_unused_result__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:577:10
pub const __wur = "";
pub const __always_inline = @compileError("unable to translate macro: undefined identifier `__always_inline__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:595:10
pub const __attribute_artificial__ = @compileError("unable to translate macro: undefined identifier `__artificial__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:604:10
pub const __extern_inline = @compileError("unable to translate macro: undefined identifier `__gnu_inline__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:622:11
pub const __extern_always_inline = @compileError("unable to translate macro: undefined identifier `__gnu_inline__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:623:11
pub const __fortify_function = __extern_always_inline ++ __attribute_artificial__;
pub const __restrict_arr = @compileError("unable to translate C expr: unexpected token '__restrict'");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:666:10
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:715:10
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:792:10
pub const __LDBL_REDIR_DECL = @compileError("unable to translate C expr: unexpected token ''");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:793:10
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:807:10
pub const __glibc_macro_warning = @compileError("unable to translate macro: undefined identifier `GCC`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:808:10
pub const __HAVE_GENERIC_SELECTION = @as(c_int, 1);
pub const __fortified_attr_access = @compileError("unable to translate C expr: unexpected token ''");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:853:11
pub const __attr_access = @compileError("unable to translate C expr: unexpected token ''");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:854:11
pub const __attr_access_none = @compileError("unable to translate C expr: unexpected token ''");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:855:11
pub const __attr_dealloc = @compileError("unable to translate C expr: unexpected token ''");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:865:10
pub const __attr_dealloc_free = "";
pub const __attribute_returns_twice__ = @compileError("unable to translate macro: undefined identifier `__returns_twice__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:872:10
pub const __attribute_struct_may_alias__ = @compileError("unable to translate macro: undefined identifier `__may_alias__`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/sys/cdefs.h:881:10
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/x86-linux-gnu/bits/floatn.h:66:12
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/x86-linux-gnu/bits/floatn.h:120:12
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:149:12
pub const __CFLOAT64 = @compileError("unable to translate: TODO _Complex");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:160:13
pub const __CFLOAT32X = @compileError("unable to translate: TODO _Complex");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:169:12
pub const __CFLOAT64X = @compileError("unable to translate: TODO _Complex");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:178:13
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:221:12
pub const __builtin_huge_valf64 = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:255:13
pub const __builtin_inff64 = @compileError("unable to translate macro: undefined identifier `__builtin_inf`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:256:13
pub const __builtin_nanf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nan`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:257:13
pub const __builtin_nansf64 = @compileError("unable to translate macro: undefined identifier `__builtin_nans`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:258:13
pub const __builtin_huge_valf32x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:272:12
pub const __builtin_inff32x = @compileError("unable to translate macro: undefined identifier `__builtin_inf`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:273:12
pub const __builtin_nanf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nan`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:274:12
pub const __builtin_nansf32x = @compileError("unable to translate macro: undefined identifier `__builtin_nans`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:275:12
pub const __builtin_huge_valf64x = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:289:13
pub const __builtin_inff64x = @compileError("unable to translate macro: undefined identifier `__builtin_infl`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:290:13
pub const __builtin_nanf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nanl`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:291:13
pub const __builtin_nansf64x = @compileError("unable to translate macro: undefined identifier `__builtin_nansl`");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/floatn-common.h:292:13
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/types.h:137:10
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/x86-linux-gnu/bits/typesizes.h:73:9
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/select.h:25:9
pub const __FD_SET = @compileError("unable to translate C expr: expected ')' instead got '|='");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/select.h:32:9
pub const __FD_CLR = @compileError("unable to translate C expr: expected ')' instead got '&='");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/select.h:34:9
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/x86-linux-gnu/bits/struct_mutex.h:56:10
pub const _RWLOCK_INTERNAL_H = "";
pub const __PTHREAD_RWLOCK_ELISION_EXTRA = @compileError("unable to translate C expr: unexpected token '{'");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/x86-linux-gnu/bits/struct_rwlock.h:40:11
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/thread-shared-types.h:114:9
...
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:105:9
pub const __putc_unlocked_body = @compileError("TODO postfix inc/dec expr");
// /home/lucas/zig-latest-linux-x86_64/lib/libc/include/generic-glibc/bits/types/struct_FILE.h:109:9
...
pub const COM_MODP_STRINGENCODERS_NUMTOA_H = "";
pub const BEGIN_C = "";
pub const END_C = "";
...
pub const EV3_H = "";
pub inline fn EV3_VAR(decl: anytype) @TypeOf(decl) {
    _ = &decl;
    return decl;
}
pub const EV3_VAR_INIT = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /home/lucas/code/projects/zig/mindstorm/ev3dev-c/source/ev3/ev3.h:17:9
pub const EV3_INL = "";
...
// /home/lucas/zig-latest-linux-x86_64/lib/include/__stddef_offsetof.h:16:9
pub const __STDBOOL_H = "";
pub const __bool_true_false_are_defined = @as(c_int, 1);
pub const @"bool" = bool;
pub const @"true" = @as(c_int, 1);
pub const @"false" = @as(c_int, 0);
pub const GPIO_KEYS_PATH = "/dev/input/by-path/platform-gpio_keys-event";
pub const DESC_LIMIT = @as(c_int, 64);
pub const DESC_VEC_LEN = @as(c_int, 4);
pub const STR_unknown_ = "<unknown>";
...
pub inline fn Sleep(msec: anytype) @TypeOf(usleep(msec * @as(c_int, 1000))) {
    _ = &msec;
    return usleep(msec * @as(c_int, 1000));
}
pub const BRICK_WAIT_DELAY = @as(c_int, 1000);
pub const BRICK_WAIT_TRIES = @as(c_int, 10);
